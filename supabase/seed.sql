...
set
  ...
  updated_at = now()
where id = (
  select id from auth.users where email = 'bzumaharjan2@gmail.com' limit 1
);
...
select
  'Nepal Open Cup',
  'A sample tournament using the built-in bracket preview and Supabase real-time match updates.',
  'Mobile Legends',
  16,
